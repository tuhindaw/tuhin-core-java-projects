...
public class CarRentalRLLearner {

    CarRentalRLWorld thisWorld;
    CarRentalRLPolicy policy;
    ...
    public CarRentalRLLearner(CarRentalRLWorld world) {
        ...
        policy = new CarRentalRLPolicy( dimSize );
        ...
        System.out.println( "CarRentalRLLearner initialised" );
    ...
    */
    ...
    public CarRentalRLPolicy getPolicy() {
    ...
    public CarRentalRLPolicy newPolicy() {
        policy = new CarRentalRLPolicy( dimSize );
        // Initializing the policy with the initial values defined by the world.
        policy.initValues( thisWorld.getInitValues() );
        return policy;
