...
public class CarRentalWorldImpl implements CarRentalRLWorld {
    public int bx, by;
    ...
    public int reward=50, penalty=10;
    ...
    public CarRentalWorldImpl(int x, int y, int numWalls) {
        bx = x;
        by = y;
    ...
    public CarRentalWorldImpl(int x, int y, boolean[][] newwalls) {
        bx = x;
        by = y;
    ...
    /******* CarRentalRLWorld interface functions ***********/
    ...
    public int[] getNextState(int action) {
        ...
        Dimension d = getCarLocationCoords(action);
    ...
    Dimension getCarLocationCoords(int action) {
        int ax=mx, ay=my;
        switch(action) {
    ...
    /******* end CarRentalRLWorld functions **********/
